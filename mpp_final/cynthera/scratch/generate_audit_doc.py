"""Generator script for clinicaltrials_gov_forensic_audit.md.
Compiles forensic findings into the final comprehensive audit report.
"""
import os
import sys
...
report_path = "clinicaltrials_gov_forensic_audit.md"

content = """# CYNTHERA — ClinicalTrials.gov Parsing & Hard-Negative Recognition FORENSIC AUDIT
...
print(f"Generated {report_path} successfully. Total lines: {len(content.splitlines())}")
